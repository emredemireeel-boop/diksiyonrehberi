...
const TP_CATEGORIES = [
  {
    ...
    texts: [
      ...
      {
        id: 'ah-saglik-bulus', title: 'Kanser Tedavisinde Umut Veren Buluş', subtitle: 'Sağlık ve bilim', difficulty: 'Orta',
        text: `Sayın seyirciler, tıp dünyasından milyonlarca hastaya umut ışığı olacak çok kritik bir son dakika haberini aktarıyoruz. Uluslararası bir araştırma konsorsiyumunun on yıldır üzerinde çalıştığı yeni nesil akıllı molekül tedavisi, klinik deneylerin üçüncü aşamasını benzeri görülmemiş bir başarıyla tamamladı.\n\nÜniversite hastanelerinde eşzamanlı olarak yürütülen ve binlerce hastayı kapsayan çalışmalarda, ilacın sadece kanserli hücreleri hedef aldığı ve sağlıklı dokulara hiçbir zarar vermeden tümörleri küçülttüğü kanıtlandı. Geleneksel kemoterapinin ağır yan etkilerini ortadan kaldıran bu yöntem, onkoloji alanında tam anlamıyla bir devrim olarak nitelendiriliyor.\n\nAraştırma ekibinin başındaki profesör, düzenlediği basın toplantısında gözyaşlarına hakim olamayarak, bilimin uzun ve meşakkatli bir sabır işi olduğunu vurguladı. Sağlık Bakanlığı, bu ilacın ruhsatlandırma sürecinin hızla tamamlanması ve geri ödeme kapsamına alınması için acil koduyla bir komisyon kurdu.\n\nHasta dernekleri ise bu gelişmeyi büyük bir sevinçle karşılarken, tedavinin herkes için erişilebilir olması gerektiği çağrısında bulunuyor.`
      },
      {
        id: 'ah-uzay-kesif', title: 'Kızıl Gezegende Yeni Yaşam İzleri', subtitle: 'Uzay araştırmaları', difficulty: 'Hızlı',
        text: `Bilim insanlarını ve tüm dünyayı heyecanlandıran sarsıcı bir keşifle bültenimize devam ediyoruz. Amerikan ve Avrupa uzay ajanslarının ortaklaşa yürüttüğü Mars misyonunda, gezegenin ekvator kuşağındaki derin bir kraterin altında sıvı halde devasa bir su rezervi tespit edildi.\n\nBölgede görev yapan insansız keşif aracının yer altı radarlarıyla elde ettiği ve az önce dünyaya ulaşan yüksek çözünürlüklü spektral verilere göre, bu gölün içerisinde mikroskobik düzeyde organik yaşam formlarının bulunma ihtimali bugüne kadar hiç olmadığı kadar yüksek. Jeologlar, bu suyun yüzeyin hemen altında milyonlarca yıldır donmadan kalabildiğini belirtiyor.\n\nBu muazzam keşif, sadece güneş sistemindeki komşumuzu daha iyi anlamamızı sağlamakla kalmıyor, aynı zamanda önümüzdeki on yıl içinde planlanan insanlı uzay seyahatlerinin rotasını ve altyapı stratejilerini de temelden değiştiriyor.\n\nUzmanlar, evrende yalnız olup olmadığımız sorusunun cevabının, o kraterin derinliklerinde saklı olduğuna ve birkaç yıl içinde kesinleşeceğine inanıyor.`
      },
      {
        id: 'ah-kultur-miras', title: 'Tarihi Eserler Yurda Dönüyor', subtitle: 'Kültürel diplomasi', difficulty: 'Yavaş',
        text: `Kıymetli izleyenler, yıllardır süren ısrarlı ve titiz diplomatik müzakereler nihayet meyvesini verdi ve Anadolu'nun sinesinden koparılan paha biçilmez tarihi eserler, asıl evine dönüyor. Kültür ve Turizm Bakanlığı'nın yoğun diplomatik baskısı sonucunda, Avrupa'nın önde gelen üç büyük müzesi mülkiyet iddialarından vazgeçtiğini açıkladı.\n\nGece yarısı özel korumalı kargo uçaklarıyla ülkeye getirilecek olan eserler arasında, milattan önce dördüncü yüzyıla ait benzersiz heykel başları, altından işlenmiş kraliyet lahitleri ve eşi benzeri bulunmayan mozaik panolar yer alıyor. Bunlar, Interpol ile yapılan ortak operasyonlar neticesinde yıllar önce yasadışı yollarla yurt dışına kaçırılmıştı.\n\nUzman arkeologlardan ve sanat tarihçilerinden oluşan geniş bir heyet, eserlerin havalimanında ilk kontrollerini büyük bir hassasiyetle gerçekleştirecek. Eserlerin restorasyon süreçlerinin tamamlanmasının ardından özel bir sergiyle ziyarete açılacağı büyük bir coşkuyla duyuruldu.\n\nBu tarihi zafer, sadece kültürel mirasımıza sahip çıkmanın değil, uluslararası hukukun gücünün de altını çizen fevkalade bir emsal teşkil ediyor.`
      },
      {
        id: 'ah-yapay-zeka', title: 'Yapay Zeka Hukukunda Küresel Zirve', subtitle: 'Teknoloji ve yasa', difficulty: 'Hızlı',
        text: `Teknolojinin baş döndürücü hızına yetişmeye çalışan kanun koyucular, insanlık tarihinin en kritik zirvelerinden biri için bugün Cenevre'de bir araya geldi. Gündemin tek ve en önemli maddesi: Yapay zekanın küresel çapta nasıl denetleneceği ve olası risklerin nasıl minimize edileceği.\n\nSilikon Vadisi'nin dev şirketlerinin yöneticilerinin de izleyici olarak katıldığı toplantıda, algoritmaların telif hakları, derin kurgu yani deepfake videoların siyasete etkisi ve otonom sistemlerin yol açtığı kazalarda hukuki sorumluluğun kime ait olacağı gibi çok sert tartışmalar yaşanıyor. Avrupa Birliği temsilcileri, yapay zekanın insan hakları sözleşmelerine tam uyumlu olması için katı yaptırımlar ve bağlayıcı lisanslama şartları getirilmesini savundu.\n\nTeknoloji liderleri ise, aşırı regülasyonların inovasyonun önünü keseceğini ve serbest piyasa dengelerini altüst edeceğini iddia ederek taslağa itiraz ediyor. Zirveden çıkacak ortak mutabakat metninin, önümüzdeki çeyrek asrın siber dünyasını tamamen şekillendirmesi bekleniyor.\n\nİnsan zekası ile makinelerin sınırlarının nerede bitip nerede başlayacağı, işte bu masada verilecek kararlarla çizilecek.`
      },
      {
        id: 'ah-dijital-para', title: 'Merkez Bankası ndan Dijital Hamle', subtitle: 'Makroekonomi', difficulty: 'Orta',
        text: `Ekonomi dünyasını temelden sarsacak ve günlük hayatımızdaki alışveriş alışkanlıklarımızı baştan aşağı değiştirecek dev bir adım atıldı. Merkez Bankası Başkanı kameraların karşısına geçerek, uzun süredir laboratuvar aşamasında tutulan Milli Dijital Para Birimi projesi olan e-Lira'nın yıl sonunda pilot uygulamaya geçeceğini resmen duyurdu.\n\nKripto paraların spekülatif dalgalanmalarından farklı olarak, tamamen devlet güvencesinde ve fiziki para rezervleriyle birebir örtüşen bu sistem, bankacılık aracılarının maliyetlerini sıfıra indirmeyi hedefliyor. İlk etapta kamu personeli maaş ödemelerinde ve belirlenen bazı büyük perakende zincirlerinde kullanıma sunulacak olan sistemin, kayıtdışı ekonomiyle mücadelede en keskin silah olacağı öngörülüyor.\n\nEkonomistler, sistemin siber güvenliği ve vatandaşların kişisel verilerinin mahremiyeti konusunda bazı endişelerini dile getirse de, projenin inovasyon açısından emsalsiz olduğunu kabul ediyorlar. Cebimizde taşıdığımız deri cüzdanlar, çok yakında yerini cep telefonlarımızdaki kriptografik şifrelere bırakacak gibi görünüyor.\n\nParanın evrimi, kâğıt ve madeniden soyut bir veri dizisine doğru hiç durmaksızın devam ediyor.`
      }
    ]
  },
  {
